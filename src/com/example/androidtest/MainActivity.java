...
import com.example.androidtest.widget.HorizontalVariableListView;
import com.example.androidtest.widget.HorizontalVariableListView.OnLayoutChangeListener;
...
public class MainActivity extends Activity {
	...
	public void onCreate( Bundle savedInstanceState ) {
		...
		TextView menuTv = (TextView)findViewById(R.id.menu01);
		...
		ListAdapter adapter = new ListAdapter( this, R.layout.horizontalview1, R.layout.horizontaldivider, data );
